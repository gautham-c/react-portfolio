...
const SectionCard = ({ title, items }: { title: string; items: string[] }) => (
  <div className="rounded-2xl border border-slate-200/70 bg-white/70 p-5 shadow-sm backdrop-blur">
    <div className="flex items-center justify-between">
      ...
      <span className="ml-4 h-px flex-1 bg-gradient-to-r from-slate-200 via-slate-200/40 to-transparent" />
    </div>
...
const SkillsPage = () => {
  ...
  return (
    <section className="relative">
      <div
        className="absolute -inset-8 rounded-[3rem] bg-gradient-to-b from-fuchsia-100/50 to-transparent blur-2xl"
        aria-hidden
      />

      <header className="relative mb-6 space-y-2">
        <p className="text-sm font-semibold tracking-wide text-fuchsia-700">
          Skills
        </p>
        ...
        <p className="max-w-3xl text-slate-700">
          Practical technologies I use to ship reliable products across the
          stack.
        </p>
      </header>
