...
const ExperiencePage = () => {
  return (
    <section className="relative">
      <div
        className="absolute -inset-8 rounded-[3rem] bg-gradient-to-b from-sky-100/50 to-transparent blur-2xl"
        aria-hidden
      />
      ...
      <header className="relative mb-6 space-y-2">
        ...
        <p className="max-w-3xl text-slate-700">
          Highlights across healthcare, SaaS, and research. Faster releases,
          fewer defects, and robust data pipelines.
        </p>
      </header>
